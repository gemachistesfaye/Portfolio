...
const Achievements = () => {
  ...
  const renderItem = (item, i, delay_offset = 0) => (
    <div
      key={item.title}
      ...
      style={{ animationDelay: `${(delay_offset + i) * 0.08}s` }}
    >
      ...
      <div ref={ref} className="max-w-6xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {achievementItems.map((item, i) => renderItem(item, i, 0))}
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {credentialItems.map((item, i) => renderItem(item, i, achievementItems.length))}
          </div>
        </div>
      </div>
