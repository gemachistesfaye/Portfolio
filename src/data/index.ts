...
export const projects: Project[] = [
  {
    ...
    outcome: "Reduced average patient wait time by 40% and enabled remote consultations for patients.",
  ...
  },
  {
    ...
    outcome: "Recovery rate improved by 60% within the first semester of deployment.",
